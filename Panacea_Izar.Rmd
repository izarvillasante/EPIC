...
dim(main_db)
```
A total of 349165 participants from the "Epic-Panacea" project with consumption data of polifenols.
...
quintile <- function(x) factor(Hmisc::cut2(x, g=5,exclude=0),labels = F)
